  ...
  return (
    <Layout>
      <div style={{
        ...
        <p style={{ color: 'var(--theme-text-muted)', marginBottom: '1rem', transition: 'color 0.3s ease' }}>Last updated: November 7, 2025</p>
        ...
        <div style={{
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ 
              ...
              color: "var(--theme-text)",
              transition: 'color 0.3s ease'
            }}>5. Data Quality, Verification & Use</h2>
            ...
            <p style={{ marginTop: '0.5rem' }}>
              Averages, indices and trend summaries exclude outliers according to our internal methodology. For bespoke extracts, raw data access, or commercial licensing please contact <a href="mailto:research@theregistry.co.ke" style={{ color: 'var(--theme-accent)', textDecoration: 'none' }}>research@theregistry.co.ke</a>.
            </p>
          </section>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ 
              ...
              color: "var(--theme-text)",
              transition: 'color 0.3s ease'
            }}>6. API, Licensing & Commercial Use</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            ...
            <p>
              Our Privacy Policy explains how we collect and process personal data. By using the Service you consent to our collection and use of personal data as described in the <Link href="/privacy" style={{ color: 'var(--theme-accent)', textDecoration: 'none' }}>Privacy Policy</Link>.
            </p>
          </section>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ 
              ...
              color: "var(--theme-text)",
              transition: 'color 0.3s ease'
            }}>11. Disclaimers & Limitation of Liability</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            ...
            <p>
              For questions about these Terms, data licensing, or bespoke data services please contact: <a href="mailto:research@theregistry.co.ke" style={{ color: 'var(--theme-accent)', textDecoration: 'none' }}>research@theregistry.co.ke</a>.
            </p>
          </section>

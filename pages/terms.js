  ...
  return (
    <Layout>
      <div style={{
        ...
        <p style={{ color: '#cfcfcf', marginBottom: '1.25rem' }}>Last updated: November 7, 2025</p>
        ...
        <div style={{
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>1. Scope and Acceptance</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>2. Definitions</h2>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>3. Eligibility</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>4. Permitted Use & Access</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>5. Data Quality, Verification & Use</h2>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>6. API, Licensing & Commercial Use</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>7. Intellectual Property</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>8. User Content & Listings</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>9. Payments and Fees</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>10. Privacy</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>11. Disclaimers & Limitation of Liability</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>12. Indemnification</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>13. Termination</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>14. Changes to Terms</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>15. Governing Law & Disputes</h2>
            <p>
          ...
          <section style={{ marginBottom: "1.25rem" }}>
            <h2 style={{ fontSize: "1.1rem", marginBottom: "0.5rem", color: "#f5f5f5" }}>16. Contact</h2>
            <p>

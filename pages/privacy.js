    ...
    <Layout>
      <div style={{
        ...
        <p style={{ 
          ...
          marginBottom: '1rem',
          transition: 'color 0.3s ease'
        }}>Last updated: November 7, 2025</p>
        ...
        <div style={{
          ...
          <section style={{ marginBottom: "1rem" }}>
            ...
            <p style={{ marginBottom: '0.4rem' }}>
              Subject to applicable law, you may have rights to access, correct, delete, or export your personal data, and to object to certain processing. To exercise these rights or ask questions, contact <a href="mailto:research@theregistry.co.ke" style={{ color: 'var(--theme-accent)', textDecoration: 'none' }}>research@theregistry.co.ke</a>.
            </p>
          </section>
          ...
          <section style={{ marginBottom: "1rem" }}>
            ...
            <p>
              For privacy questions, data requests, or licensing enquiries contact: <a href="mailto:research@theregistry.co.ke" style={{ color: 'var(--theme-accent)', textDecoration: 'none' }}>research@theregistry.co.ke</a>.
            </p>
          </section>

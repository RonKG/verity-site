...
export default function Contact() {
  ...
  const socialIcons = (
    <>
      <SocialIcon href="https://linkedin.com/company/theregistry" label="LinkedIn">
      ...
      <SocialIcon href="https://wa.me/254700000000" label="WhatsApp">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="rgba(0,0,0,0.8)">
      ...
      <SocialIcon href="https://instagram.com/theregistry.ke" label="Instagram">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="rgba(0,0,0,0.8)">
      ...
      <SocialIcon href="https://twitter.com/theregistry_ke" label="Twitter">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="rgba(0,0,0,0.8)">
          <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
        </svg>
      </SocialIcon>

      <SocialIcon href="https://youtube.com/@theregistry" label="YouTube">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="rgba(0,0,0,0.8)">
      ...
      <div style={{
        ...
        <main style={{ 
          ...
          <section style={{
            ...
            {/* Social Media Links - Bottom of Form */}
            <div style={{ 
              marginTop: 'auto',
              paddingTop: '1.5rem', 
          ...
          <aside style={{
            ...
            <div style={{ display: 'grid', gap: '0.75rem', flexGrow: 1 }}>
              <div>
            ...
            {/* Social Media Links - Bottom of Contact Card */}
            <div style={{ 
              marginTop: 'auto',
              paddingTop: '1.5rem', 
              borderTop: \`1px solid var(--theme-border)\`,
